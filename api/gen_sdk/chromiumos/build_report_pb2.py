...
BuildReportBeta = _reflection.GeneratedProtocolMessageType('BuildReportBeta', (_message.Message,), dict(
  ...
  StepDetails = _reflection.GeneratedProtocolMessageType('StepDetails', (_message.Message,), dict(
