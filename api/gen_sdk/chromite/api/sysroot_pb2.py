...
_INSTALLTOOLCHAINRESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='failed_package_data', full_name='chromite.api.InstallToolchainResponse.failed_package_data', index=0,
...
_INSTALLPACKAGESRESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='events', full_name='chromite.api.InstallPackagesResponse.events', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='goma_artifacts', full_name='chromite.api.InstallPackagesResponse.goma_artifacts', index=1,
      number=3, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='failed_package_data', full_name='chromite.api.InstallPackagesResponse.failed_package_data', index=2,
      number=4, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
