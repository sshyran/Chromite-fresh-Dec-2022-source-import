...
_FIRMWAREARTIFACTINFO = _descriptor.Descriptor(
  ...
  nested_types=[_FIRMWAREARTIFACTINFO_TARBALLINFO, _FIRMWAREARTIFACTINFO_OBJECTINFO, ],
  enum_types=[
  ],
  serialized_options=None,
  is_extendable=False,
