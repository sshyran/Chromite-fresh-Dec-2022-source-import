...
GetLatestBuildRequest = _reflection.GeneratedProtocolMessageType('GetLatestBuildRequest', (_message.Message,), dict(
...
GetLatestBuildResponse = _reflection.GeneratedProtocolMessageType('GetLatestBuildResponse', (_message.Message,), dict(
