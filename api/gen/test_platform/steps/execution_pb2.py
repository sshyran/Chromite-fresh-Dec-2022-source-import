...
_EXECUTERESPONSE_TASKRESULT = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='rejected_task_dimensions', full_name='test_platform.steps.ExecuteResponse.TaskResult.rejected_task_dimensions', index=9,
