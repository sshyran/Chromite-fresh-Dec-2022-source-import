...
class TestNetMetrics(cros_test_lib.TestCase):
    ...
    def test_collect(self):
        with mock.patch(
            ...
            net_io_counters.return_value = {
                "lo": snetio(
                    ...
                    bytes_recv=172474956,
                    packets_sent=109564455,
                    packets_recv=1095644,
                    errin=10,
                    errout=1,
                    dropin=20,
                    dropout=2,
        ...
        calls = [
            ...
            mock.call(
                "dev/net/errors", ("up", "lo"), None, 1, enforce_ge=mock.ANY
            ),
            mock.call(
                "dev/net/errors", ("down", "lo"), None, 10, enforce_ge=mock.ANY
            ),
            mock.call(
                "dev/net/dropped", ("up", "lo"), None, 2, enforce_ge=mock.ANY
            ),
            mock.call(
                "dev/net/dropped", ("down", "lo"), None, 20, enforce_ge=mock.ANY
            ),
            mock.call("dev/net/isup", ("lo",), None, True, enforce_ge=mock.ANY),
            mock.call("dev/net/duplex", ("lo",), None, 0, enforce_ge=mock.ANY),
            mock.call("dev/net/speed", ("lo",), None, 0, enforce_ge=mock.ANY),
            mock.call("dev/net/mtu", ("lo",), None, 65536, enforce_ge=mock.ANY),
            mock.call(
                "net/fqdn", (), None, "foo.example.com", enforce_ge=mock.ANY
            ),
            mock.call(
                "dev/net/address",
                ("AF_LINK", "lo"),
