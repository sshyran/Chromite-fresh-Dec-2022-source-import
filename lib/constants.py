...
LEGACY_RELEASE_DENYLIST = [
    ...
    'betty-arc-t-release',
    'betty-arc-u-release',
    'betty-kernelnext-release',
    'brya-hibernate-release',
    ...
    'jacuzzi64-release',
    'kalista-cfm-release',
    'kalista-kernelnext-release',
    'kevin-kernelnext-release',
    'kevin-userdebug-release',
    'kevin64-release',
    'kukui-arc-r-release',
    'kukui-kernelnext-release',
    'lars-kernelnext-release',
    'majolica-release',
    'mushu-release',
    'nami-kernelnext-release',
    'nocturne-kernelnext-release',
    'octopus-arc-r-release',
    'octopus-kernelnext-release',
    'palkia-release',
    'puff-borealis-release',
    'puff-macrophage-release',
    'puff-moblab-release',
    'rammus-arc-r-release',
    'rammus-arc-r-userdebug-release',
    'reven-release',
    'reven-release',
    ...
    'trogdor-arc-r-release',
    'trogdor-connectivitynext-release',
    'trogdor-kernelnext-release',
