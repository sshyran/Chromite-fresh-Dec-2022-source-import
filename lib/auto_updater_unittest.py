...
class TransferMock(partial_mock.PartialCmdMock):
    ...
    ATTRS = (
        "TransferUpdateUtilsPackage",
        "TransferRootfsUpdate",
...
class ChromiumOSUpdaterBaseTest(cros_test_lib.MockTempDirTestCase):
    ...
    def setUp(self):
        ...
        self.PatchObject(
            remote_access.ChromiumOSDevice, "Pingable", return_value=True
        )
...
class TransferTest(ChromiumOSUpdaterBaseTest):
    ...
    def testTransferForRootfs(self):
        ...
        with remote_access.ChromiumOSDeviceHandler(
            ...
            CrOS_AU.RunUpdate()
            self.assertTrue(self._transfer_mock.patched["CheckPayloads"].called)
            self.assertTrue(
...
class ChromiumOSUpdatePreCheckTest(ChromiumOSUpdaterBaseTest):
    ...
    def testCheckRestoreStatefulError(self):
        ...
        with remote_access.ChromiumOSDeviceHandler(
            ...
            self.PatchObject(
                cros_build_lib, "BooleanPrompt", return_value=False
            )
            self.PatchObject(
            ...
            self.assertRaises(
                auto_updater.ChromiumOSUpdateError, CrOS_AU.RunUpdate
            )
...
class ChromiumOSUpdaterRunTest(ChromiumOSUpdaterBaseTest):
    ...
    def testRestoreStateful(self):
        ...
        with remote_access.ChromiumOSDeviceHandler(
            ...
            CrOS_AU.RunUpdate()
            self.assertTrue(
                self._base_updater_mock.patched["RestoreStateful"].called
            )
    ...
    def testRunRootfs(self):
        ...
        with remote_access.ChromiumOSDeviceHandler(
            ...
            stateful_update_mock = self.PatchObject(
                auto_updater.ChromiumOSUpdater, "UpdateStateful"
            )
            ...
            self.assertTrue(
                self._base_updater_mock.patched["UpdateRootfs"].called
            )
    ...
    def testUpdateStatefulCopyStateful(self):
        ...
        with remote_access.ChromiumOSDeviceHandler(
            ...
            update_mock = self.PatchObject(
                stateful_updater.StatefulUpdater, "Update"
            )

            CrOS_AU.RunUpdate()
            update_mock.assert_called_with(
                auto_updater_transfer.STATEFUL_FILENAME,
                is_payload_on_device=True,
                update_type=None,
            )
            self.assertTrue(
                self._transfer_mock.patched["TransferStatefulUpdate"].called
    ...
    def testUpdateStatefulNoCopyStateful(self):
        ...
        with remote_access.ChromiumOSDeviceHandler(
            ...
            update_mock.assert_called_with(
                os.path.join(
                    self._payload_dir, auto_updater_transfer.STATEFUL_FILENAME
                ),
...
class ChromiumOSUpdaterRunErrorTest(ChromiumOSErrorTest):
    ...
    def testRestoreStatefulError(self):
        ...
        with remote_access.ChromiumOSDeviceHandler(
            ...
            self.PatchObject(
                auto_updater.ChromiumOSUpdater, "SetupRootfsUpdate"
            )
            self.PatchObject(auto_updater.ChromiumOSUpdater, "RunUpdateRootfs")
            self.PatchObject(
                auto_updater.ChromiumOSUpdater, "PreSetupStatefulUpdate"
            )
            self.PatchObject(
                auto_updater.ChromiumOSUpdater, "ResetStatefulPartition"
            )
            self.PatchObject(auto_updater.ChromiumOSUpdater, "UpdateStateful")
            self.PatchObject(
                auto_updater.ChromiumOSUpdater, "PostCheckStatefulUpdate"
            )
            self.PatchObject(
                auto_updater.ChromiumOSUpdater, "_IsUpdateUtilsPackageInstalled"
            )
            self.PatchObject(
                auto_updater.ChromiumOSUpdater,
                "_CheckNebraskaCanRun",
    ...
    def testSetupRootfsUpdateError(self):
        ...
        with remote_access.ChromiumOSDeviceHandler(
            ...
            self.PatchObject(
                auto_updater.ChromiumOSUpdater, "_StartUpdateEngineIfNotRunning"
            )
            self.PatchObject(
                auto_updater.ChromiumOSUpdater,
                "GetUpdateStatus",
    ...
    def testRootfsUpdateNebraskaError(self):
        ...
        with remote_access.ChromiumOSDeviceHandler(
            ...
            self.PatchObject(
                auto_updater.ChromiumOSUpdater, "RevertBootPartition"
            )
            with mock.patch("os.path.join", return_value=""):
                self.assertRaises(
                    auto_updater.RootfsUpdateError, CrOS_AU.RunUpdate
                )
    ...
    def testStatefulUpdateCmdError(self):
        ...
        with remote_access.ChromiumOSDeviceHandler(
            ...
            self.PatchObject(
                stateful_updater.StatefulUpdater,
                "Update",
            ...
            self.assertRaises(
                auto_updater.StatefulUpdateError, CrOS_AU.RunUpdate
            )
    ...
    def testVerifyErrorWithSameRootDev(self):
        ...
        with remote_access.ChromiumOSDeviceHandler(
            ...
            self.assertRaises(
                auto_updater.AutoUpdateVerifyError, CrOS_AU.RunUpdate
            )
    ...
    def testVerifyErrorWithRootDevEqualsNone(self):
        ...
        with remote_access.ChromiumOSDeviceHandler(
            ...
            self.PatchObject(remote_access.ChromiumOSDevice, "run")
            self.PatchObject(
                auto_updater.ChromiumOSUpdater, "GetRootDev", return_value=None
            )
            self.assertRaises(
                auto_updater.AutoUpdateVerifyError, CrOS_AU.RunUpdate
            )
