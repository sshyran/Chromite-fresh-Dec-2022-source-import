...
class BasePaygenBuildLibTestWithBuilds(BasePaygenBuildLibTest,
  ...
  def setUp(self):
    ...
    self.minios_full_payload = gspaths.Payload(tgt_image=self.basic_image,
                                               minios=True)
...
class TestPaygenBuildLibTestGSSearch(BasePaygenBuildLibTestWithBuilds):
  ...
  def testDiscoverMiniOSSignedImages(self):
    ...
    expected_basic = gspaths.MiniOSImage(build=self.target_build, key='mp-v3',
                                         uri=uri_basic)
    expected_premp = gspaths.MiniOSImage(build=self.target_build, key='premp',
                                         uri=uri_premp)
    expected_result = [expected_basic, expected_premp]
...
class MockImageDiscoveryHelper(BasePaygenBuildLibTest):
  ...
  def addMiniOSSignedImage(self, build, key='mp'):
    ...
    image = gspaths.MiniOSImage(build=build, key=key,
...
class TestPaygenBuildLibDiscoverRequiredPayloads(MockImageDiscoveryHelper,
  ...
  def testCanaryEverything(self):
    ...
    mp_full_minios = gspaths.Payload(
        ...
        uri='gs://crt/canary-channel/auron-yuna/9999.0.0/payloads/minios/minios_9999.0.0_auron-yuna_canary-channel_full_mp.bin-<random>.signed', minios=True)
    premp_full_minios = gspaths.Payload(
        tgt_image=premp_image_minios,
        uri='gs://crt/canary-channel/auron-yuna/9999.0.0/payloads/minios/minios_9999.0.0_auron-yuna_canary-channel_full_premp.bin-<random>.signed', minios=True)
    ...
    mp_delta_minios = gspaths.Payload(
        ...
        uri='gs://crt/canary-channel/auron-yuna/9999.0.0/payloads/minios/minios_9756.0.0-9999.0.0_auron-yuna_canary-channel_delta_mp.bin-<random>.signed', minios=True)
    premp_delta_minios = gspaths.Payload(
        tgt_image=premp_image_minios,
        src_image=prev_premp_image_minios,
        uri='gs://crt/canary-channel/auron-yuna/9999.0.0/payloads/minios/minios_9756.0.0-9999.0.0_auron-yuna_canary-channel_delta_premp.bin-<random>.signed', minios=True)
  ...
  def testStable(self):
    ...
    mp_delta_8743_minios = gspaths.Payload(
        tgt_image=mp_image_minios, src_image=image_8743_minios, uri=mock.ANY,
        minios=True)
    ...
    mp_delta_8872_minios = gspaths.Payload(
        tgt_image=mp_image_minios, src_image=image_8872_minios, uri=mock.ANY,
        minios=True)
    ...
    mp_delta_9000_minios = gspaths.Payload(
        tgt_image=mp_image_minios, src_image=image_9000_minios, uri=mock.ANY,
        minios=True)
    ...
    mp_delta_9202_minios = gspaths.Payload(
        tgt_image=mp_image_minios, src_image=image_9202_minios, uri=mock.ANY,
        minios=True)
    ...
    mp_delta_9334_minios = gspaths.Payload(
        tgt_image=mp_image_minios, src_image=image_9334_minios, uri=mock.ANY,
        minios=True)
    ...
    mp_delta_9460_minios = gspaths.Payload(
        tgt_image=mp_image_minios, src_image=image_9460_minios, uri=mock.ANY,
        minios=True)
    ...
    mp_delta_9460_67_minios = gspaths.Payload(
        tgt_image=mp_image_minios, src_image=image_9460_67_minios, uri=mock.ANY,
        minios=True)
