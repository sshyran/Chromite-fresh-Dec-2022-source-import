  ...
  def __init__(self,
    ...
    Args:
      ...
      work_dir: A working directory inside the chroot to put temporary files.
        ...
        logs and metadata files, payload and metadata hashes along with their
        signatures, the payload itself, postinstall config file, intermediate
        files that is generated by the signer, etc.
      ...
      private_key: If passed, the payload will be signed with that private key.
        If also verify is True, the public key is extracted from the private key
