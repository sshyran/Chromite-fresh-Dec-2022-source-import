...
class GceTest(cros_test_lib.MockTempDirTestCase):
    ...
    def testGetImage(self):
        ...
        gce_context = gce.GceContext.ForServiceAccount(
            self._PROJECT, self._ZONE, self.json_key_file
        )
        self.assertDictEqual(
            gce_context.GetImage("foo-image"), dict(name="foo-image")
        )
    ...
    def _MockOutBuildRetriableRequest(self, mock_http):
        ...
        def _BuildRetriableRequest(
            ...
            **kwargs,
            ...
            return gce.RetryOnServerErrorHttpRequest(
                num_retries, mock_http, *args, **kwargs
            )
