...
def test_execute():
  ...
  """
  with mock.patch('chromite.lib.portage_util.FindOverlays', return_value=[
    ...
    assert test_output.overlays == [
        spiderlib.Overlay(Path('src/overlays/baseboard-brya'),
                          'baseboard-brya'),
        spiderlib.Overlay(Path('src/overlays/overlay-oak'), 'oak'),
        spiderlib.Overlay(Path('src/private-overlays/chipset-picasso-private'),
                          'chipset-picasso-private'),
        spiderlib.Overlay(Path('src/private-overlays/overlay-oak-private'),
                          'oak-private'),
        spiderlib.Overlay(Path('src/third_party/portage-stable'),
                          'portage-stable'),
    ]
